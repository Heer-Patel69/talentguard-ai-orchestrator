...
import { Check, X, ArrowRight, Zap, Building2, Rocket, Crown, HelpCircle, MessageSquare } from "lucide-react";
...
const plans = [{
  ...
  popular: false,
  features: [{
    text: "Up to 25 interviews/month",
    included: true
  }, {
    text: "3 active job postings",
    included: true
  }, {
    text: "AI resume screening",
    included: true
  }, {
    text: "MCQ assessments",
    included: true
  }, {
    text: "Coding challenges (5 languages)",
    included: true
  }, {
    text: "Voice AI interviews",
    included: true
  }, {
    text: "Basic fraud detection",
    included: true
  }, {
    text: "Email support",
    included: true
  ...
  popular: true,
  features: [{
    text: "Up to 100 interviews/month",
    included: true
  }, {
    text: "10 active job postings",
    included: true
  }, {
    text: "AI resume screening",
    included: true
    ...
    text: "Coding challenges (20+ languages)",
    included: true
  }, {
    text: "Voice AI interviews",
    included: true
  ...
  features: [{
    ...
    text: "Coding challenges (all languages)",
    included: true
  }, {
    text: "Voice AI interviews",
    included: true
  }, {
    text: "Advanced fraud detection + custom rules",
    included: true
  }, {
    text: "24/7 phone, email & chat support",
    included: true
  }, {
    text: "Custom branding",
    included: true
...
export default function PricingPage() {
  return <div className="min-h-screen">
        ...
        <Container>
          <div className="grid gap-8 md:grid-cols-3">
            ...
            duration: 0.5
                ...
                <GlassCard className={`h-full ${plan.popular ? 'border-primary/50 bg-primary/5' : ''}`} elevated={plan.popular}>
                  ...
                  <ul className="space-y-3 mb-8">
                    {plan.features.map(feature => <li key={feature.text} className="flex items-start gap-2">
                        {feature.included ? <Check className="h-5 w-5 text-success shrink-0 mt-0.5" /> : <X className="h-5 w-5 text-muted-foreground/50 shrink-0 mt-0.5" />}
                  ...
                  <Button variant={plan.ctaVariant} className="w-full" size="lg" asChild>
      ...
      <Section>
        <Container>
          <SectionHeader eyebrow="Compare Plans" title="Detailed feature comparison" />
          ...
          <GlassCard className="overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  {comparisonFeatures.map((feature, index) => <tr key={feature.name} className={index % 2 === 0 ? 'bg-secondary/20' : ''}>
                      <td className="p-4 font-medium">{feature.name}</td>
                      <td className="text-center p-4">
                        {typeof feature.starter === 'boolean' ? feature.starter ? <Check className="h-5 w-5 text-success mx-auto" /> : <X className="h-5 w-5 text-muted-foreground/50 mx-auto" /> : feature.starter}
                      </td>
                      <td className="text-center p-4 bg-primary/5">
                        {typeof feature.pro === 'boolean' ? feature.pro ? <Check className="h-5 w-5 text-success mx-auto" /> : <X className="h-5 w-5 text-muted-foreground/50 mx-auto" /> : feature.pro}
                      </td>
                      <td className="text-center p-4">
                        {typeof feature.enterprise === 'boolean' ? feature.enterprise ? <Check className="h-5 w-5 text-success mx-auto" /> : <X className="h-5 w-5 text-muted-foreground/50 mx-auto" /> : feature.enterprise}
                      </td>
                    </tr>)}
                </tbody>
              </table>
      ...
      <Section>
        <Container>
          <SectionHeader eyebrow="FAQ" title="Frequently asked questions" description="Everything you need to know about our pricing and plans." />
