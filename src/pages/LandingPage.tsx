    ...
    <div className="min-h-screen">
      ...
      <Section className="pt-32 md:pt-40">
        <Container>
          ...
          >
            <GlassCard elevated className="mx-auto max-w-5xl overflow-hidden p-0">
            ...
            {[
              ...
              >
                <div className="flex flex-col items-center">
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-primary text-xl font-bold">
                    {item.step}
                  </div>
                  {index < 2 && (
      ...
      <Section>
        <Container>
          <GlassCard elevated className="gradient-border mx-auto max-w-4xl text-center">
