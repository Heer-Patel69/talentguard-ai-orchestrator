                    ...
                    <div key={stage.stage}>
                      ...
                      <div className="h-8 overflow-hidden rounded-lg bg-secondary">
                        <motion.div
                          ...
                          className={cn("h-full rounded-lg", colors[idx])}
                        />
                      </div>
                    </div>
                  );
                ...
                {liveInterviews?.map((interview) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-primary/60 text-sm font-bold text-primary-foreground">
