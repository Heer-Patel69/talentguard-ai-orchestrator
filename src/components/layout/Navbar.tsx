  ...
  return (
    <>
      ...
      >
        <nav
          className={cn(
            "mx-4 mt-4 rounded-2xl border px-6 py-4 md:mx-auto md:max-w-6xl transition-all duration-300",
            isScrolled
              ? "glass-card-elevated border-border/50 bg-background/80 backdrop-blur-xl shadow-lg"
